...
assert.equal(window.FLIGHT_TRANSLATIONS.sk.text["contact.title"], "Podpora a Kontakt");
assert.equal(window.FLIGHT_TRANSLATIONS.en.text["contact.title"], "Support & Contact");
