...
assert.equal(window.FLIGHT_TRANSLATIONS.sk.text["contact.title"], "Kontakt a podpora");
assert.equal(window.FLIGHT_TRANSLATIONS.en.text["contact.title"], "Contact & Support");
