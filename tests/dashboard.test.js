...
assert.equal(element("#planning-window-filter").classList.contains("weekend-day"), true);
...
assert.match(html, /class="weekend-legend"[\s\S]+Tmavosivá označuje víkend/);
...
assert.match(css, /\.planning-slider\s*\{[^}]*background:\s*#d5dde9/);
